...
use AuditorFramework\Module\Risk\Domain\BankReader\ReadModel\BorrowerBankReaderReadModel;
...
class MysqlCamUnitProjector extends AbstractReadModel implements CamUnitProjector
{
    ...
    public function reset(): void
    {
        ...
        $this->connection->executeQuery("TRUNCATE TABLE auditor_framework.risk_bank_reader_bank_account;");
        $this->connection->executeQuery("TRUNCATE TABLE auditor_framework.risk_bank_reader_bank_account_statement;");
        $this->connection->executeQuery("TRUNCATE TABLE auditor_framework.risk_bank_account;");
        $this->connection->executeQuery("TRUNCATE TABLE auditor_framework.risk_bank_reader_statement;");
        $this->enableForeignKeys();
    }
